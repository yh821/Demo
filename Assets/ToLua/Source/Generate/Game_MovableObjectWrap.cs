...
public class Game_MovableObjectWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(Game.MovableObject), typeof(UnityEngine.MonoBehaviour));
	...
	static int Reset(IntPtr L)
	{
		try
		{
			...
			Game.MovableObject obj = (Game.MovableObject)ToLua.CheckObject(L, 1, typeof(Game.MovableObject));
			obj.Reset();
			return 0;
		}
		catch (Exception e)
	...
	static int MoveTo(IntPtr L)
	{
		try
		{
			...
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to method: Game.MovableObject.MoveTo");
			}
		}
		catch (Exception e)
		{
	...
	static int GetWalkableHeight(IntPtr L)
	{
		try
		{
			...
			if (count == 2)
			{
				...
				float o = Game.MovableObject.GetWalkableHeight(arg0, arg1);
			...
			else if (count == 3)
			{
				...
				float o = Game.MovableObject.GetWalkableHeight(arg0, arg1, arg2);
				LuaDLL.lua_pushnumber(L, o);
				return 1;
			}
			else
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to method: Game.MovableObject.GetWalkableHeight");
			}
		}
		catch (Exception e)
		{
	...
	static int get_moveSpeed(IntPtr L)
	{
		...
		try
		{
			...
			Game.MovableObject obj = (Game.MovableObject)o;
