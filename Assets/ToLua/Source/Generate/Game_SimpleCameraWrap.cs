...
public class Game_SimpleCameraWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(Game.SimpleCamera), typeof(UnityEngine.MonoBehaviour));
	...
	static int Swipe(IntPtr L)
	{
		try
		{
			...
			Game.SimpleCamera obj = (Game.SimpleCamera)ToLua.CheckObject<Game.SimpleCamera>(L, 1);
	...
	static int get_minAngle(IntPtr L)
	{
		...
		try
		{
			...
			Game.SimpleCamera obj = (Game.SimpleCamera)o;
