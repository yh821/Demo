...
public class Game_AnimatorStateListenerWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(Game.AnimatorStateListener), typeof(UnityEngine.StateMachineBehaviour));
		L.RegFunction("OnStateEnter", OnStateEnter);
		L.RegFunction("OnStateExit", OnStateExit);
		L.RegFunction("New", _CreateGame_AnimatorStateListener);
	...
	static int _CreateGame_AnimatorStateListener(IntPtr L)
	{
		try
		{
			...
			if (count == 0)
			{
				Game.AnimatorStateListener obj = new Game.AnimatorStateListener();
				ToLua.Push(L, obj);
				return 1;
			}
			else
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to ctor method: Game.AnimatorStateListener.New");
			}
		}
		catch (Exception e)
		{
	...
	static int OnStateEnter(IntPtr L)
	{
		try
		{
			...
			if (count == 4)
			{
				Game.AnimatorStateListener obj = (Game.AnimatorStateListener)ToLua.CheckObject<Game.AnimatorStateListener>(L, 1);
			...
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to method: Game.AnimatorStateListener.OnStateEnter");
			}
		}
		catch (Exception e)
		{
	...
	static int OnStateExit(IntPtr L)
	{
		try
		{
			...
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to method: Game.AnimatorStateListener.OnStateExit");
			}
		}
		catch (Exception e)
		{
	...
	static int get_onStateEnter(IntPtr L)
	{
		...
		try
		{
			...
			Game.AnimatorStateListener obj = (Game.AnimatorStateListener)o;
