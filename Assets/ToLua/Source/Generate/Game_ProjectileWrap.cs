...
public class Game_ProjectileWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(Game.Projectile), typeof(UnityEngine.MonoBehaviour));
	...
	static int Play(IntPtr L)
	{
		try
		{
			...
			Game.Projectile obj = (Game.Projectile)ToLua.CheckObject<Game.Projectile>(L, 1);
