...
public class Game_UIJoystickWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(Game.UIJoystick), typeof(UnityEngine.MonoBehaviour));
	...
	static int SetDynamicRange(IntPtr L)
	{
		try
		{
			...
			Game.UIJoystick obj = (Game.UIJoystick)ToLua.CheckObject(L, 1, typeof(Game.UIJoystick));
	...
	static int get_onDragBegin(IntPtr L)
	{
		...
		try
		{
			...
			Game.UIJoystick obj = (Game.UIJoystick)o;
