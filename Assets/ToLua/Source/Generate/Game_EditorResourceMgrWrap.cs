...
public class Game_EditorResourceMgrWrap
{
	...
	static int IsExitsAsset(IntPtr L)
	{
		try
		{
			...
			bool o = Game.EditorResourceMgr.IsExitsAsset(arg0, arg1);
	...
	static int LoadGameObject(IntPtr L)
	{
		try
		{
			...
			string arg0 = ToLua.CheckString(L, 1);
			string arg1 = ToLua.CheckString(L, 2);
			UnityEngine.GameObject o = Game.EditorResourceMgr.LoadGameObject(arg0, arg1);
	...
	static int LoadObject(IntPtr L)
	{
		try
		{
			...
			UnityEngine.Object o = Game.EditorResourceMgr.LoadObject(arg0, arg1, arg2);
			ToLua.Push(L, o);
			return 1;
		}
		catch (Exception e)
	...
	static int LoadSceneSync(IntPtr L)
	{
		try
		{
			...
			bool o = Game.EditorResourceMgr.LoadSceneSync(arg0, arg1, arg2);
			LuaDLL.lua_pushboolean(L, o);
			return 1;
		}
		catch (Exception e)
	...
	static int LoadSceneAsync(IntPtr L)
	{
		try
		{
			...
			string arg1 = ToLua.CheckString(L, 2);
			UnityEngine.SceneManagement.LoadSceneMode arg2 = (UnityEngine.SceneManagement.LoadSceneMode)ToLua.CheckObject(L, 3, typeof(UnityEngine.SceneManagement.LoadSceneMode));
			bool o = Game.EditorResourceMgr.LoadSceneAsync(arg0, arg1, arg2);
			LuaDLL.lua_pushboolean(L, o);
			return 1;
		}
		catch (Exception e)
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int CacheOriginalInstanceMapping(IntPtr L)
	{
		try
		{
			ToLua.CheckArgsCount(L, 2);
			...
			Game.EditorResourceMgr.CacheOriginalInstanceMapping(arg0, arg1);
			return 0;
		}
		catch (Exception e)
		{
	...
	static int SweepOriginalInstanceIdMap(IntPtr L)
	{
		try
		{
			...
			Game.EditorResourceMgr.SweepOriginalInstanceIdMap();
			return 0;
		}
		catch (Exception e)
		{
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int GetOriginalInstanceId(IntPtr L)
	{
		try
		{
			ToLua.CheckArgsCount(L, 1);
			UnityEngine.GameObject arg0 = (UnityEngine.GameObject)ToLua.CheckObject(L, 1, typeof(UnityEngine.GameObject));
			int o = Game.EditorResourceMgr.GetOriginalInstanceId(arg0);
	...
	static int GetAssetPath(IntPtr L)
	{
		try
		{
			...
			string o = Game.EditorResourceMgr.GetAssetPath(arg0);
	...
	static int OutputAssetPathMap(IntPtr L)
	{
		...
		{
			ToLua.CheckArgsCount(L, 0);
			Game.EditorResourceMgr.OutputAssetPathMap();
			return 0;
		}
		catch (Exception e)
		{
	...
	static int IsCanLoadAssetInGameObj(IntPtr L)
	{
		try
		{
			...
			bool o = Game.EditorResourceMgr.IsCanLoadAssetInGameObj(arg0, arg1, arg2);
			LuaDLL.lua_pushboolean(L, o);
			return 1;
		}
		catch (Exception e)
