...
public class Packager
{
    ...
    static void HandleLuaBundle()
    {
        ...
        string[] srcDirs = {CustomSettings.luaDir, Application.dataPath + "/ToLua/ToLua/Lua"};
    ...
    [MenuItem("LuaFramework/DebugMode", true)]
    public static bool DebugModeValidate()
    {
        Menu.SetChecked("LuaFramework/DebugMode", AppConst.DebugMode);
        return true;
    }

    [MenuItem("LuaFramework/DebugMode", false, 2000)]
    public static void DebugMode()
    {
        AppConst.DebugMode = !AppConst.DebugMode;
    }

    [MenuItem("LuaFramework/LuaBundleMode", true)]
    public static bool LuaBundleModeValidate()
    {
        Menu.SetChecked("LuaFramework/LuaBundleMode", AppConst.LuaBundleMode);
        return true;
    }

    [MenuItem("LuaFramework/LuaBundleMode", false, 2001)]
    public static void LuaBundleMode()
    {
        AppConst.LuaBundleMode = !AppConst.LuaBundleMode;
    }
}